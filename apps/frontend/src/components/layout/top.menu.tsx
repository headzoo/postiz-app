...
export const useMenuItem = () => {
  ...
  const firstMenu = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M13.3333 18.8337V17.167C13.3333 16.0945 12.9071 15.0653 12.1569 14.3152C11.4068 13.565 10.3775 13.1387 9.305 13.1387C8.23246 13.1387 7.20319 13.565 6.45304 14.3152C5.7029 15.0653 5.27667 16.0945 5.27667 17.167V18.8337M16.6667 18.8337V17.0003C16.6662 16.0801 16.3605 15.188 15.7998 14.4588C15.239 13.7296 14.4559 13.2049 13.57 12.967M2.94333 12.967C2.05665 13.2038 1.27256 13.7281 0.710871 14.4574C0.149185 15.1866 -0.157734 16.0792 -0.158333 17.0003V18.8337M10.805 4.80533C10.805 6.36622 9.53255 7.63867 7.97167 7.63867C6.41078 7.63867 5.13833 6.36622 5.13833 4.80533C5.13833 3.24445 6.41078 1.972 7.97167 1.972C9.53255 1.972 10.805 3.24445 10.805 4.80533ZM16.1383 7.63867C16.1383 8.78926 15.2056 9.722 14.055 9.722C12.9044 9.722 11.9717 8.78926 11.9717 7.63867C11.9717 6.48807 12.9044 5.55533 14.055 5.55533C15.2056 5.55533 16.1383 6.48807 16.1383 7.63867Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M10 5.5V10.5M10 10.5V15.5M10 10.5H15M10 10.5H5M18.3333 10.5C18.3333 15.1024 14.6024 18.8333 10 18.8333C5.39763 18.8333 1.66667 15.1024 1.66667 10.5C1.66667 5.89763 5.39763 2.16667 10 2.16667C14.6024 2.16667 18.3333 5.89763 18.3333 10.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const secondMenu = [
    ...
    },
    {
      ...
      path: 'https://affiliate.postplusplus.com',
      role: ['ADMIN', 'SUPERADMIN', 'USER'],
      requireBilling: true,
    },
    {
