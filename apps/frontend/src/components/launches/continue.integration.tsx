  ...
  useEffect(() => {
    (async () => {
      ...
      if (data.status === HttpStatusCode.NotAcceptable) {
        ...
        navigateOrShow(`/calendar?msg=${msg}`, returnURL, msg);
        return;
      }
      ...
      navigateOrShow(
        `/calendar?added=${provider}&msg=Channel Updated${
  ...
  const onSave = useCallback(
    async (data: any) => {
      ...
      try {
        ...
        navigateOrShow(
          `/calendar?added=${provider}&msg=Channel Added${
    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-[#eb3825] rounded-full blur-[120px]" />
    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          {logged && <Redirect url="/calendar" delay={3000} />}
        </div>
      </div>
    );
  }
